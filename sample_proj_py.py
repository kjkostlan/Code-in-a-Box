...
def _install_gitpacks(): # Runs once on "import proj"
    ...
    packs = {}
    packs['./games/Tetris'] = 'https://github.com/LoveDaisy/tetris_game'
    packs['./games/Pacman'] = 'https://github.com/hbokmann/Pacman'
    packs['./games/Space_invaders'] = 'https://github.com/attreyabhatt/Space-Invaders-Pygame'
    packs['./games/Stroad_strider'] = 'https://github.com/jgubert/frogger'
    packs['./games/Arkanoid'] = 'https://github.com/wkeeling/arkanoid'
